...
struct scene_object_impl {
    void (*release)(struct scene_object *object);
    void (*render)(struct scene_object *object);
};

struct scene_object {
    struct wl_list link; // scene.objects
    const struct scene_object_impl *impl;
};
...
static void add_object(struct scene *scene, struct scene_object *object,
                       const struct scene_object_impl *impl);
...
static const struct scene_object_impl image_impl = {
...
static const struct scene_object_impl mirror_impl = {
    .release = mirror_release,
    .render = mirror_render,
};
...
static const struct scene_object_impl text_impl = {
...
static void
add_object(struct scene *scene, struct scene_object *object, const struct scene_object_impl *impl) {
...
scene_add_image(struct scene *scene, const struct scene_image_options *options, void *pngbuf,
    ...
    add_object(scene, (struct scene_object *)image, &image_impl);
...
scene_add_mirror(struct scene *scene, const struct scene_mirror_options *options) {
    ...
    add_object(scene, (struct scene_object *)mirror, &mirror_impl);
...
scene_add_text(struct scene *scene, const char *data, const struct scene_text_options *options) {
    ...
    add_object(scene, (struct scene_object *)text, &text_impl);
